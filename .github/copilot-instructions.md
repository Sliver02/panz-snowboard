# GitHub Copilot Instructions for Lorenzo Panzera Sport & Adventure — Next.js 15 Project
...
```powershell
git clone https://github.com/Sliver02/panz-snowboard.git
cd panz-snowboard
```
...
│   └── sections/              # AboutMe, Winter, Summer, Contact, Booking (page sections)
├── common/
...
- **sections/**: AboutMe, Winter, Summer, Contact, Booking (full page sections — client components)
...
- Maps all website routes: `HOME`, `ABOUT`, `WINTER`, `SUMMER`, `BOOKING`, `CONTACT`
- Import: `import { RouteEnum } from "@/common/routeEnum";`
- Usage: `<Link href={RouteEnum.ABOUT}>`, `<a href={RouteEnum.WINTER}>`
- **Never hardcode paths** like `"/chi-sono"` or `"/#contact"` — use the enum
