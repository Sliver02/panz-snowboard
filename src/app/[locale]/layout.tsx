...
export const metadata: Metadata = {
	title: {
		default: "Lorenzo Panzera | Snowboard, Telemark, Mountain bike, Hiking, Dolomites, Cortina",
	...
	openGraph: {
		title: "Lorenzo Panzera | Snowboard, Telemark, Mountain bike, Hiking, Dolomites, Cortina",
		description:
	...
	return (
		...
		>
			<head>
				...
				<link rel="alternate" href="https://lorenzopanzera.com/" hrefLang="x-default" />
				<script
